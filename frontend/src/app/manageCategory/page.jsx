...
const ManageUser = () => {
    ...
    const fetchUserList = () => {
        axios.get('http://localhost:5000/categoryForm/getall')
    ...
    const deleteUser = (id) => {
        axios.delete(`http://localhost:5000/categoryForm/delete/` + id)
            .then((result) => {
                            ...
                            userList.map((user) => {
                                ...
                                <td onClick={() => deleteUser(user._id)}  className='p-2 border border-violet-700'
                                    ...
                                    <td  className='p-2 border border-violet-700'>
                                        <Link href={'/updateCategory/' + user._id} className='bg-yellow-500 text-white px-4 py-2 rounded-lg'>
                                            Update
                                        </Link>
                                    </td>
                                </tr>
